...
void TestSimpleTanh() {
  ...
  auto expected = CreateTensor<float>(
      {2, 2, 2, 2},
      {-0.99999834f, 0.99999834f, -0.99998771f, 0.99998771f, -0.9999092f, 0.9999092f,
       -0.9993293f, 0.9993293f, -0.99505475f, 0.99505475f, -0.96402758f, 0.96402758f,
       -0.76159416f, 0.76159416f, 0.f, 0.f});
...
void TestSimpleSigmoid() {
  ...
  auto expected = CreateTensor<float>(
      {2, 2, 2, 2},
      {9.11051194e-04f, 9.99088949e-01f, 2.47262316e-03f, 9.97527377e-01f,
       6.69285092e-03f, 9.93307149e-01f, 1.79862100e-02f, 9.82013790e-01f,
       4.74258732e-02f, 9.52574127e-01f, 1.19202922e-01f, 8.80797078e-01f,
       2.68941421e-01f, 7.31058579e-01f, 5.00000000e-01f, 5.00000000e-01f});
