...
TEST_F(QuantizeTest, TestQuantize) {
  ...
  auto expected_min = CreateTensor<float>({1}, {-3.01887f});
...
TEST_F(QuantizeTest, TestDequantize) {
  ...
  net.AddInputFromArray<CPU, float>("InputMin", {1}, {-3.01887f});
  net.AddInputFromArray<CPU, float>("InputMax", {1}, {5});
  ...
  ExpectTensorNear<float>(*expected_output, *output, 0.1f, 0.01f);
}
...
TEST_F(QuantizeTest, TestRequantizeWithMinMax) {
  ...
  net.AddInputFromArray<CPU, float>("InputMin", {1}, {-3});
  net.AddInputFromArray<CPU, float>("InputMax", {1}, {5});
  net.AddInputFromArray<CPU, float>("RerangeMin", {1}, {-3.01887f});
