...
macro(easy_mace_add_unit_tests FILES_DIR DEP_MODULES)
  file(GLOB_RECURSE UNIT_TESTS_FILES "${FILES_DIR}/*.cc")
  foreach(test_file ${UNIT_TESTS_FILES})
    get_filename_component(TEST_NAME ${test_file} NAME_WE)
    add_executable(${TEST_NAME} ${test_file})
    target_link_libraries(${TEST_NAME} gtest gtest_main ${DEP_MODULES})
